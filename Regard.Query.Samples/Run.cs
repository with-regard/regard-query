    ...
    public static class Run
    {
        ...
        public static void Main()
        {
            ...
            var runIt = Task.Run(async () =>
            {
                ...
                await recorder.RecordEvent(WellKnownUserIdentifier.TestUser, sessionId, "WithRegard", "Test", JObject.FromObject(new
                    {
                        Day = 1,
                        Test = "Hello"
                    }));
                ...
                await recorder.RecordEvent(WellKnownUserIdentifier.TestUser, Guid.NewGuid(), "WithRegard", "Test", JObject.FromObject(new
                {
                    Day = 3478,
                    EventType = "BadEvent",
                    SessionId = 8
